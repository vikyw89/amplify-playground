...
@InputType()
class ChatMessageCreateNestedManyWithoutThreadsInput {
...
export { ChatMessageCreateNestedManyWithoutThreadsInput as ChatMessageCreateNestedManyWithoutThreadsInput };
